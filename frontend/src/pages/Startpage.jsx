  ...
  return (
    <div className="w-full min-h-screen bg-black text-white relative">
      <button
        ...
        className="absolute top-10 right-40 bg-black text-white px-4 py-2 rounded hover:bg-red-700"
      >
        Login
      </button>
      <button
        onClick={() => setIsRegisterOpen(true)}
        className="absolute top-10 right-10 bg-black text-white px-4 py-2 rounded hover:bg-red-700"
      >
        Register
      </button>
        ...
        <div className="max-w-7xl w-full flex flex-col md:flex-row items-center gap-10">
          <div className="flex-1">
            ...
            <p className="text-gray-200 mb-6 max-w-md">
              I'm a Full Stack Developer skilled in building dynamic web
              applications using React, Node.js, Django, and MySQL...
            </p>
            <button
              onClick={() => navigate("/AboutMe")}
              className="border border-white text-white px-6 py-2 hover:bg-white hover:text-pink-600"
            >
              About Me
            </button>
          </div>
